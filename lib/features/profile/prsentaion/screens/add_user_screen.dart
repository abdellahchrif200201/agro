...
import 'package:devti_agro/features/profile/prsentaion/widgets/text_field_user_widget.dart';
...
class _AddUserScreenState extends State<AddUserScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.user == null ? S.of(context).create_new : "Edit user",
          style: TextStyle(color: Colors.black),
        ),
        backgroundColor: Theme.of(context).appBarTheme.backgroundColor,
        leading: IconButton(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFieldUserWidget(
                    ...
                    label: S.of(context).enter_email,
                  ),
                  const SizedBox(height: 40),
                  TextField(
                    controller: _passwordController,
