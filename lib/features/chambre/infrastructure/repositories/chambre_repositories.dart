...
abstract class ChambresRepository{
  Future<Either<Failure , List<Chambre>>> getAllChambres(int page);
  ...
  Future<Either<Failure, Unit>> updateChambre(Chambre chambre);
  Future<Either<Failure, Unit>> deleteChambre(int id);
}
